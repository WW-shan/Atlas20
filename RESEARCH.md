...
以更保守的 **14D balanced top1 ex-BTC + 75D/3 自身止损 + BTC 100D MA confirm2 + 60D 波动率目标 50%** 为例：

| 往返总成本 | 全样本 | Sharpe | 最大回撤 | 2025–2026 测试段 | 1 年滚动最差窗口 |
|---|---:|---:|---:|---:|---:|
| 2bps | 4.43x | 1.153 | -33.1% | 1.71x | 0.822x |
| 20bps | 3.91x | 1.069 | -33.9% | 1.64x | 0.812x |
| 100bps | 2.23x | 0.695 | -37.7% | 1.36x | 0.766x |
...
- 这个版本在 2023 年明显跑输 BTC，但在 2022、2025、2026 大幅胜出；
- 100bps 压力下仍约为 BTC 的 1.23 倍，但 1 年滚动最差窗口约 0.77x，不是无风险；
